...
var useThemeMode = () => {
  ...
  const { mode: contextMode, toggleMode = onToggleMode } = (0, import_react.useContext)(ThemeContext);
  const [mode, setModeState] = (0, import_react.useState)(contextMode ? contextMode : getPrefersColorScheme());
  const setMode = (0, import_react.useCallback)((mode2) => {
...
var AccordionPanelContext = (0, import_react2.createContext)(void 0);
function useAccordionContext() {
  const context = (0, import_react2.useContext)(AccordionPanelContext);
  if (!context) {
...
var AccordionPanel = ({ children, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react3.useState)(props.isOpen);
...
var AccordionComponent = ({ alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, collapseAll = false, className, theme: customTheme = {}, ...props }) => {
  ...
  const panels = (0, import_react4.useMemo)(() => import_react4.Children.map(children, (child, i2) => (0, import_react4.cloneElement)(child, { alwaysOpen, arrowIcon, flush, isOpen: isOpen === i2, setOpen: () => setOpen(i2) })), [alwaysOpen, arrowIcon, children, flush, isOpen]);
...
var Flowbite = ({ children, theme: theme2 = {} }) => {
  ...
  const themeContextValue = (0, import_react5.useMemo)(() => ({
    theme: mergedTheme,
    mode,
    toggleMode
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react8.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, ...props }) => {
  ...
  const attachCloseListener = (0, import_react18.useCallback)(
  ...
  const content = (0, import_react18.useMemo)(() => (0, import_jsx_runtime24.jsx)("ul", { className: theme2.content, children: import_react18.Children.map(children, attachCloseListener) }), [attachCloseListener, children, theme2.content]);
...
// node_modules/flowbite-react/lib/esm/components/FileInput/FileInput.js
var FileInput = (0, import_react19.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var ModalContext = (0, import_react21.createContext)(void 0);
function useModalContext() {
  const context = (0, import_react21.useContext)(ModalContext);
  if (!context) {
...
var NavbarContext = (0, import_react23.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react23.useContext)(NavbarContext);
  if (!context) {
...
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  const [isOpen, setIsOpen] = (0, import_react24.useState)(menuOpen);
...
var Radio = (0, import_react26.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
...
var RangeSlider = (0, import_react27.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Select = (0, import_react29.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var SidebarContext = (0, import_react30.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react30.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react31.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react31.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const [isOpen, setOpen] = (0, import_react32.useState)(open);
  const theme2 = mergeDeep(useTheme().theme.sidebar.collapse, customTheme);
  (0, import_react32.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react33.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  var _a, _b, _c, _d;
...
// node_modules/flowbite-react/lib/esm/components/Tab/Tabs.js
var TabsComponent = (0, import_react35.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.tab, customTheme);
  const id = (0, import_react35.useId)();
  const tabs = (0, import_react35.useMemo)(() => import_react35.Children.map(children, ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react35.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react35.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react35.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
...
var TableContext = (0, import_react36.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react36.useContext)(TableContext);
  if (!context) {
...
var TimelineContext = (0, import_react39.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react39.useContext)(TimelineContext);
  if (!context) {
...
var ToastContext = (0, import_react40.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react40.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react41.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react41.useState)(false);
